...
void TrySkipPatch()
{
    ...
    *(void**)0x004010A8 = (void*)&rtcMsgBoxHook;
    ...
    PATCH(0x998607)
        ...
        .JMP((uintptr_t) runtimeHookUpdateJumpingAndSpinjumpingForce<&PlayerPhysics::jumpHeight, &PlayerPhysics::spinjumpHeight>)
        .Apply();
    ...
    PATCH(0x99E32D)
        .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerID
        .PUSH_IMM32(0x99E358)
        .JMP((uintptr_t) runtimeHookUpdateJumpingForce<&PlayerPhysics::spinjumpHeight>)
        .Apply();
    ...
    PATCH(0x99D61C)
        .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerID
        .PUSH_IMM32(0x99D658)
        .JMP((uintptr_t) runtimeHookUpdateJumpingForce<&PlayerPhysics::shellJumpHeight>)
        .Apply();
    ...
    PATCH(0x9A5C45)
        .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerID
        .PUSH_IMM32(0x9A5C92)
        .JMP((uintptr_t) runtimeHookUpdateJumpingAndSpinjumpingForce<&PlayerPhysics::noteBlockJumpHeight, &PlayerPhysics::noteBlockSpinjumpHeight>)
        .Apply();
    ...
    PATCH(0x9B08E5)
        ...
        .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerID
        .PUSH_IMM32(0x9B092E)
        .JMP((uintptr_t) runtimeHookUpdateJumpingAndSpinjumpingForce<&PlayerPhysics::npcJumpHeight, &PlayerPhysics::npcSpinjumpHeight>)
        .Apply();
    ...
    PATCH(0x9B0856)
        .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerID
        .PUSH_IMM32(0x9B089F)
        .JMP((uintptr_t) runtimeHookUpdateJumpingAndSpinjumpingForce<&PlayerPhysics::springJumpHeight, &PlayerPhysics::springSpinjumpHeight>)
        .Apply();
    ...
    for (std::uint32_t *i = terminalVelocityPatchAddresses; *i != 0; i++) {
        PATCH(*i)
            .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerID
            .CALL((uintptr_t) runtimeHookGetPhysicsField<float, &PlayerPhysics::terminalVelocity>)
    ...
    PATCH(0x8D393D)
        .PUSH_ECX()
        .CALL((uintptr_t) runtimeHookGetPhysicsField<float, &PlayerPhysics::runSpeed>)
        .Apply();
    ...
    for (std::uint32_t *i = waterGravityPatchAddresses; *i != 0; i++) {
        PATCH(*i)
            .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerId
            .CALL((uintptr_t) runtimeHookGetPhysicsField<float, &PlayerPhysics::waterGravity>)
            .NOP()
            .Apply();
    }
    ...
    PATCH(0x99EC52)
        .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerId
        .CALL((uintptr_t) runtimeHookGetPhysicsField<float, &PlayerPhysics::propellerForce>)
        .bytes(0x66, 0x0F, 0x1F, 0x84, 0x00, 0x00, 0x00, 0x00, 0x00) // nop
        .bytes(0x0F, 0x1F, 0x84, 0x00, 0x00, 0x00, 0x00, 0x00) // nop
        .Apply();
    ...
    PATCH(0x99ECA2)
        .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerId
        .CALL((uintptr_t) runtimeHookGetPhysicsField<float, &PlayerPhysics::propellerTerminalVelocity>)
        .NOP()
        .Apply();

    PATCH(0x99ECBE) // Replaces fcomp by fcom so we don't have to compute propellerTerminalVelocity twice
        .bytes(0xD8, 0x95, 0x14, 0xF2, 0xFF, 0xFF) // fcom dword ptr [ebp - 0xDEC]
        .Apply();
    ...
    for (std::uint32_t *i = flyingShellTerminalVelocityPatchAddresses; *i != 0; i++) {
        PATCH(*i)
            .bytes(0xFF, 0xB5, 0xEC, 0xFE, 0xFF, 0xFF) // push dword ptr [ebp - 0x114] ; playerId
            .CALL((uintptr_t) runtimeHookGetPhysicsField<float, &PlayerPhysics::flyingShellTerminalVelocity>)
            .NOP()
            .Apply();
    }
