...
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::jumpHeight>() { return 0; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::noteBlockJumpHeight>() { return 1; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::headJumpHeight>() { return 2; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::npcJumpHeight>() { return 3; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::springJumpHeight>() { return 4; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::jumpVelocity>() { return 5; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::runSpeed>() { return 6; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::walkSpeed>() { return 7; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::terminalVelocity>() { return 8; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::gravity>() { return 9; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::spinjumpHeight>() { return 10; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::shellJumpHeight>() { return 11; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::noteBlockSpinjumpHeight>() { return 12; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::headSpinjumpHeight>() { return 13; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::npcSpinjumpHeight>() { return 14; };
template <> constexpr std::size_t physicsMemberPos<short, &PlayerPhysics::springSpinjumpHeight>() { return 15; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::minimalPMeterSpeed>() { return 16; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::waterGravity>() { return 17; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::waterTerminalVelocity>() { return 18; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::propellerForce>() { return 19; };
template <> constexpr std::size_t physicsMemberPos<float, &PlayerPhysics::propellerTerminalVelocity>() { return 20; };
